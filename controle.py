...
banco = mysql.connector.connect(
    ...
    #Definindo funções da tela de editar: tabela Widget.
...
def editar_dados():
    ...
    #Definindo funções de Salvar dados apos a edição.
...
def salvar_dados_editados(): 
    ...
    #Definindo a exclusão dos dados. 
...
def excluir_dados():
    ...
    #Definindo a função principal do cardapio e Salvando(as) no banco. 
...
def funcao_principal():
    ...
    if formulario.radioButton.isChecked() :
        print("Categoria X Burguer foi selecionada")
        categoria ="X Burguer R$18,99"
    elif formulario.radioButton_2.isChecked() :
        print("Categoria X Bacon foi selecionada")
        categoria ="X Bacon R$19,50"
    else :
        print("Categoria Hot Dog selecionada")
        categoria ="Hot Dog R$15,99"

    print("Comanda:",linha1)
    print("Cliente:",linha2)
    ...
    #Definindo função da tela de listagem dos produtos. 
